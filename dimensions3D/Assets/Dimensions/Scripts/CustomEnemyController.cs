...
namespace Dimensions
{
    ...
    public class CustomEnemyController : MonoBehaviour
    {
        ...
        public Unity.FPS.AI.PatrolPath PatrolPath { get; set; }
        public GameObject KnownDetectedTarget => DetectionModule.KnownDetectedTarget;
        public bool IsTargetInAttackRange => DetectionModule.IsTargetInAttackRange;
        public bool IsSeeingTarget => DetectionModule.IsSeeingTarget;
        public bool HadKnownTarget => DetectionModule.HadKnownTarget;
        public NavMeshAgent NavMeshAgent { get; private set; }
        public Unity.FPS.AI.DetectionModule DetectionModule { get; private set; }
        ...
        void Start()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<Actor, CustomEnemyController>(m_Actor, this, gameObject);
            ...
            var detectionModules = GetComponentsInChildren<Unity.FPS.AI.DetectionModule>();
            DebugUtility.HandleErrorIfNoComponentFound<Unity.FPS.AI.DetectionModule, CustomEnemyController>(detectionModules.Length, this,
                gameObject);
            DebugUtility.HandleWarningIfDuplicateObjects<Unity.FPS.AI.DetectionModule, CustomEnemyController>(detectionModules.Length,
                this, gameObject);
            ...
            var navigationModules = GetComponentsInChildren<Unity.FPS.AI.NavigationModule>();
            DebugUtility.HandleWarningIfDuplicateObjects<Unity.FPS.AI.DetectionModule, CustomEnemyController>(detectionModules.Length,
                this, gameObject);
        ...
        void OnDie()
        {
            ...
            m_CustomEnemyManager.UnregisterEnemy(this);
        ...
        void FindAndInitializeAllWeapons()
        {
            ...
            if (m_Weapons == null)
            {
                ...
                DebugUtility.HandleErrorIfNoComponentFound<WeaponController, CustomEnemyController>(m_Weapons.Length, this,
                    gameObject);
        ...
        public WeaponController GetCurrentWeapon()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<WeaponController, CustomEnemyController>(m_CurrentWeapon, this,
                gameObject);
